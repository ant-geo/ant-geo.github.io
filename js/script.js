  var app = angular.module('app', ['mongolab', 'pascalprecht.translate']);
  ...
  app.controller('homeCtrl', ['$scope', '$translate', '$http', '$location', 'Task', 'filterFilter', function($scope, $translate, $http, $location, Task, filterFilter) {
      ...
      $scope.searchInit = function() {
          ...
          $scope.searchArr = filterFilter($scope.tasks, {
              name: $scope.filterAnt
          });
          setTimeout(function() {
      ...
      $scope.selectLenguage = 'ru';

      $scope.selectedLang = function(value) {
          $translate.use(value);
      };
      ...
      $scope.remplacer = function(oid, nameParam, commentParam, coorXParam, coorYParam, timeParam) {
          Task.update({
              id: oid
          }, {
              name: nameParam,
              comment: commentParam,
              coordinateX: coorXParam,
              coordinateY: coorYParam,
              time: timeParam
          }, function() {
              alert("success");
          });
